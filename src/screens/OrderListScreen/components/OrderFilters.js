...
class OrderFilters extends React.Component {
    ...
    setFilters = () => {
        ...
        this.setState({isFilterChanged: false, isFilterApplied: this.isFilterActive() })
                       ...
                       <Col span={12} style={{padding: '10px', paddingTop: 0}}>
                           ...
                           >
                               ...
                               { this.props.products && this.props.products.map( (stateObject) => {
                                   return (
                                       <Option value={stateObject.idproducto}>{stateObject.codindas} / {stateObject.codnacional} - {stateObject.nombre}</Option>
                                   );
                               } ) }
                           </Select>
                       </Col>
                       ...
                       <Col span={24} align="right">
                           <div style={{alignSelf: 'flex-end'}}>
                               ...
                               <Button
                                   icon= 'search'
                                   type="primary"
                                   disabled={( ! this.isFilterActive() && ! this.state.isFilterApplied ) || (this.isFilterActive() && !this.state.isFilterChanged )}
