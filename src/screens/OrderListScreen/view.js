...
import {Table, Icon, Button, Row, Col, Tooltip, Spin} from 'antd';
...
import {LoadingOutlined, ArrowsAltOutlined, ShrinkOutlined, DeleteOutlined, ExportOutlined} from "@ant-design/icons";
...
class OrderListScreen extends React.Component {
  constructor(props) {
    ...
    this.prepareFilterParams = this.prepareFilterParams.bind(this)
  }
  ...
  render() {
    const { searchByClient, filters, exportLoading, searchByCodPedido, searchByEntity, searchByType, searchByState } = this.state;
    ...
    return (
      <Maincontainer>
        <div className="table-indas table-indas-new">
          ...
          <TableContainer>
            <div>
              <Tooltip key={2} title={"Exportar datos." }>
                <Button
                    type="link"
                    ...
                    onClick={
                      () => {
                        ...
                        api.exportOrders( this.prepareFilterParams(filters) , () => {
            ...
            {orders.length > 0 && (<div class="table-actions" style={{ height: '40px'}}>
            <div class="">

              <Tooltip title={ this.state.expandedKeys.length > 0 ? "Contraer todas las celdas." : "Expandir todas las celdas." }>
          ...
          <ModalDetailOrder
            ...
            ok={this.handleOk}
            onRefresh={this.handleSubmitOrdersSearch}
