      ...
      <div className="table-action-button">
        ...
        {selectedRowKeys.length == 1 && (
          <React.Fragment>
            <Link
              to={{
                pathname: `/campaña/${selectedRowKeys[0]}/editar`,
                search: "editar",
              }}
            >
            ...
            <Link
              to={{
                pathname: `/campaña/${selectedRowKeys[0]}/copiar`,
                search: "copiar",
              }}
            >
              <Button type="link" style={{ marginLeft: "0px", marginRight: "0px" }}>
...
export default CampanasActions;
