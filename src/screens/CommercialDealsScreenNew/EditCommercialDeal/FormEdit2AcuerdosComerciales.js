...
import {
	...
	productosFiltrados,
	getMarcas,
	getFamilia, getByIdAcuerdoComerciale, editAcuerdosComerciales
...
import {
	...
	LeftOutlined,
	DoubleLeftOutlined,
	DeleteRowOutlined, FolderAddOutlined
						...
						<Row style={{ width: '100%', marginBottom: 0, paddingBottom: 0, marginTop: 10 }}>
							...
							<Col span={3}>
								<div className="btn-box">
									{inputList.length !== 1 &&
										<Button onClick={handleRemoveClick} style={ i <=0 ? { marginTop: '30px' }: { marginTop: '10px' }} className="ant-btn-dangerous" >
											<DeleteRowOutlined />
										</Button>
									}
								</div>
