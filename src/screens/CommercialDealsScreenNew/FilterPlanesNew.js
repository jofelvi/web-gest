      ...
      <InputsContainer style={{ width: "100%", marginBottom: 0, paddingBottom: 0 }}>
        <Row key={"filters_b"} style={{ width: "100%", marginBottom: 0 }}>
          ...
          <Col span={6} style={{ padding: "10px" }} key={"col_2"}>
            ...
            <InputBox placeholder="Código Cliente" value={codsClientSelect[0].codcli_cbim || ""} disabled style={{ width: "100%" }} />
          </Col>
        </Row>
      </InputsContainer>
      <InputsContainer
        ...
        <Row style={{ width: "100%" }}>
          ...
          <Col span={5} style={{ padding: "10px", paddingTop: 0 }}>
            ...
            <Select
              ...
              onChange={(value) => setParametros({ ...parametros, idestado: value })}
              style={{ width: "100%", marginTop: "10px", paddingLeft: 0, marginLeft: 10 }}
            >
              <Option value="" style={{ color: "#CCC" }}>
                - Seleccione -
