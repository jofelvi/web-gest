...
export const obtenerValoresIniciales = function(taskVariables) {
	console.log("regularizar.regularizar.lib.obotenerValoresIniciales.taskVariables: ", taskVariables);
	...
	console.log("regularizar.regularizar.lib.obotenerValoresIniciales.initValue: ", initValue);
