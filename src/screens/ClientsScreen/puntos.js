...
import { getEntityPuntos } from '../../modules/clients-indas/actions';
...
class ClientsPuntosScreen extends React.Component {
    ...
    render() {
        const { loading, data, page, count, selectedRowKeys, filters, codentidad_cbim } = this.state;
...
}), { getEntityPuntos  } )( withRouter(ClientsPuntosScreen) );
