...
const defaultState = {
  ...
  measuringUnitSelected: MEASURING_UNIT_SELECTED.PVM,
    statsPedidos: [],
    statsPedidosLoading: true,
    statsClientes: [],
    statsClientesLoading: true,
    statsPedidosPorGrupo: [],
    statsPedidosPorGrupoLoading: true,
};

export default handleActions(
  {[fetchStatsSetLoading]: (state, { payload }) => {
      return {
          ...state,
          statsPedidosLoading: true,
          statsPedidosPorGrupoLoading: true,
      ...
      [fetchStatsPedidosPorGrupoSuccess]: (state, { payload }) => ({
          ...state,
          statsPedidosPorGrupo: payload.data,
          statsPedidosPorGrupoLoading: false,
      }),
      [fetchStatsClientesSuccess]: (state, { payload }) => ({
          ...state,
          statsClientes: payload !== null ? payload.data : [],
          statsClientesLoading: payload === null,
      }),
      [fetchStatsPedidosSuccess]: (state, { payload }) => ({
          ...state,
          statsPedidos: payload.data,
          statsPedidosLoading: false,
      }),
