import {
    ...
    FILTER_ACTIVE, GET_FILTER_DATA, LIMPIAR_BTN,
    GET_MARCAS,
    GET_FAMILIA
} from './constans';
...
export const getAcuerdosComerciales = () => async (dispatch) => {
    ...
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/acuerdo`, {
        headers: {
...
export const getMarcas = () => async (dispatch) => {
    let token = utils.getAuthToken()
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/marca`, {
        headers: {
            'Content-Type': 'application/json',
            'accept': 'application/json',
            'Authorization': `Bearer ${token}`
...
export const getFamilia = () => async (dispatch) => {
    let token = utils.getAuthToken()
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/familia`, {
        headers: {
            'Content-Type': 'application/json',
            'accept': 'application/json',
            'Authorization': `Bearer ${token}`
...
export const getSubmarcas = () => async (dispatch) => {
    let token = utils.getAuthToken()
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/submarca` , {
        headers: {
            'Content-Type': 'application/json',
            'accept': 'application/json',
            'Authorization': `Bearer ${token}`
...
export const createAcuerdosComerciales = (body) => async (dispatch) => {
    ...
    let response = await axios.post(`${process.env.REACT_APP_API_BASE_URL}ntr/acuerdo/create`, body, {
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
        }
...
export const editAcuerdosComerciales = (body, id) => async (dispatch) => {
    ...
    let response = await axios.patch(`${process.env.REACT_APP_API_BASE_URL}ntr/acuerdo/${id}`, body, {
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
        }
...
export const getByIdAcuerdoComerciale = (id) => async (dispatch) => {
    ...
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/acuerdo/${id}`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    }).then((response) => {
...
export const getDelegado = () => async (dispatch) => {
    ...
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/delegado`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    }).then((response) => {
...
export const getExcelAc = (parametros) => async (dispatch) => {
    let token = utils.getAuthToken()
    console.log("funcion llamar api")
    let response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}ntr/acuerdo?formato=excel`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    }).then((response) => {
